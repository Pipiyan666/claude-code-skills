...
> ⚠️ **来源标注**：此文档**不是『灵感胶囊』项目的原创**。
>
> - **原始位置**：`~/nanoclaw/docs/SDK_DEEP_DIVE.md`（用户本地的 nanoclaw 项目）
> - **复制时间**：2026-04-12
> - **复制原因**：用户朋友写的 `CLAUDE_AGENT_SDK_MULTI_MODEL.md` 因 iCloud dataless file bug 丢失，
>   在搜索替代品时发现这份内容更全面的 SDK 逆向工程笔记
> - **关系**：替代品（不是原文），但主题覆盖更广。原版还在等用户从 iCloud.com 找回
> - **价值**：V4 Claude Agent SDK 集成的核心参考资料
>
> ---
